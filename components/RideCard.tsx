...
const RideCard = ({ride :{
    destination_latitude,destination_address,destination_longitude,origin_address,created_at,
    ride_time,driver,payment_status
}}: {ride:Ride}) => {
  return (
        ...
        <View className='flex flex-col items-center justify-between p-3'>
            ...
            <View className='flex flex-col w-full mt-5 bg-general-500 rounded-lg p-3 items-start justify-center'>
                    ...
                    <View className='flex flex-row items-center w-full justify-between mb-5'>
                        ...
                        <Text className={`capitalize text-md font-JakartaMedium text-gray-500 ${payment_status ==='paid'?'text-green-500':'text-red-500'}`}>{payment_status}</Text>
                    </View>
            </View>
        </View>
    </View>
